...
class ThresholdsPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text("thresholds_desc".tr, style: const TextStyle(fontSize: 14, color: Colors.grey)),
            ...
            Obx(() => SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                  controller.isLoading.value ? "saving...".tr : "save_settings".tr, 
  ...
  Widget _buildThresholdCard({required String title, required String subtitle, required double value, required Color color, required IconData icon, required Function(double) onChanged}) {
    return Container(
      ...
      child: Row(
        children: [
          ...
          DropdownButton<int>(
            ...
            items: [5, 10, 15, 30].map((val) => DropdownMenuItem(value: val, child: Text("$val min"))).toList(),
  ...
  void _showSuccessMessage() {
    Get.snackbar("config_updated".tr, "pump_logic_desc".tr, snackPosition: SnackPosition.BOTTOM, backgroundColor: Colors.green[800], colorText: Colors.white, icon: const Icon(Icons.check_circle, color: Colors.white));
  }
}